...
public class Constants {
	public static final String AUTH_CODE_TO_ALLOW = "authCodeToAllow";
	public static final String AUTH_CODE_TO_RECORD_ANNOUNCEMENT = "authCodeToRecordAnnouncement";
	public static final String FORK_OPTION = "forkOption";
